...
if ( !class_exists( 'TwitterTagBuilder' ) ) {
    class TwitterTagBuilder extends TagBuilder {
        public function __construct($prefix = 'twitter', $fieldPrefix = 'twt_') 
        {
            $this->prefix = $prefix;
        ...
        public function createCustomFields(): void 
        {
            ...
            if ( function_exists( 'add_meta_box' ) ) {
                foreach ( $this->postTypes as $postType ) {
                    add_meta_box( constants::PLUGIN_PREFIX . $this->fieldPrefix .'fields', 'Twitter Tags', array( $this, 'displayFields' ), $postType, 'normal', 'high' );
                }
            }
        }
